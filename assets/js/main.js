...
(function() {
    ...
    var _0x12705 = document[_$_4993[105]](_$_4993[104])
      ...
      , _0x12751 = function(_0x12777) {
        ...
        if (_0x126DF) {
            console.log('if Bu ne amk ?'+_0x1266D);
            ...
            console.log('Bu ne amk ?'+_0x1266D);
...
(function() {
    ...
    function getLink(url, query, divId)   {
         $.ajax({

                             type: "GET",
                             url: url,
                             data: query, // appears as $_GET['id'] @ your backend side
